...
(1, 'Swifttt', '14.55', '640006', 'The course aims to enable students to analyze problems problemsolving skills basic math to get quality training and exercise by learning the basic concepts and theory of limits theory basic concepts of functions of one variable calculus multifunction calc', 'Mohamed Salah', 'uploads/114.jpg', 1),
(2, 'Web Development', '20.00', '12504', 'This course is designed to help students get to know the basic knowledge of Chinese calligraphy arts and teach them how to appreciate the arts', 'Mohamed', 'uploads/102.jpg', 1),
...
(39, 'french', '50', '', 'i lvoe this course', 'Mohamed', 'uploads/102.jpg', 1);
...
(221, 1123279351, 497188908, 'hi', 1, 'there is a proplem here', 0, '2022-01-15 22:41:38'),
(222, 1123279351, 497188908, ' i need help', 1, NULL, 0, '2022-01-15 22:41:43'),
(223, 1123279351, 497188908, 'uploads/1.jpg', 1, NULL, 1, '2022-01-15 22:41:56'),
(226, 1123279351, 497188908, 'help', 1, 'there is aporplme here', 0, '2022-01-15 22:50:43'),
(227, 497188908, 1123279351, 'hi', 0, 'hihihih', 0, '2022-01-15 22:51:33'),
(228, 497188908, 1123279351, 'i recvied your message ', 0, 'hi', 0, '2022-01-15 22:51:38'),
(229, 497188908, 1123279351, 'uploads/background.jpg', 0, NULL, 1, '2022-01-15 22:51:45');
...
('136', '1', 'testtwo', '4', 'i love this course', '2022-01-15 22:40:20', 'uploads/5.jpg');
...
(135, 'testone', 'Swift', 1, '14.55', '2022-01-15 22:26:32', 0),
(135, 'testone', 'Web Development', 2, '20.00', '2022-01-15 22:26:32', 0),
(136, 'testtwo', 'Swift', 1, '14.55', '2022-01-15 22:40:01', 0),
(136, 'testtwo', 'Web Development', 2, '20.00', '2022-01-15 22:40:01', 0);
...
('Student', 136, 'testtwo@gmail.come', '0f7e44a922df352c05c5f73cb40ba115', 'testtwo', 'male', 'uploads/5.jpg', 'Offline now', 497188908);
...
--
ALTER TABLE `course`
  MODIFY `courseId` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `messages`
--
ALTER TABLE `messages`
  MODIFY `msg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=230;
...
--
ALTER TABLE `users`
  MODIFY `userid` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
COMMIT;
